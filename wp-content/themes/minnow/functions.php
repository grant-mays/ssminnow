...
function minnow_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'minnow' ),
	) );
 ...
 */
function minnow_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'minnow_content_width', 640 );
}
add_action( 'after_setup_theme', 'minnow_content_width', 0 );
...
function minnow_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'minnow' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'minnow' ),
...
function minnow_scripts() {
	...
	wp_enqueue_script( 'minnow-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'minnow-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
